...
elem5.send_keys("删除测试文件夹")
elem6 = driver.find_element_by_css_selector(".sure")
elem6.click()
time.sleep(2)

#勾选文件夹
elem7 = driver.find_element_by_xpath("//a[@class='display-name' and @title='删除测试文件夹']/../../../..").find_element_by_class_name("item-checkbox") #勾选文件
elem7.click()
time.sleep(1)
...
time.sleep(1)
elem9 = driver.find_element_by_class_name("delete")
elem9.click()
time.sleep(1)
elem10 = driver.find_element_by_xpath("//a[@class='dialog-button confirm-ok ok']")
elem10.click()