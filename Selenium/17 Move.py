...
#勾选测试文档
elem12 = driver.find_element_by_xpath("//a[@class='display-name' and @title='移动测试文档.docx']/../../../..").find_element_by_class_name("item-checkbox")
elem12.click()
time.sleep(1)
...
elem15.click()
time.sleep(1)
elem16 = driver.find_element_by_xpath("//span[@class='jqtree-title jqtree_common'and @title='移动测试文件夹']")
elem16.click()
time.sleep(1)
elem17 = driver.find_element_by_id("move-file")
elem17.click()
