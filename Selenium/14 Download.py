...
elem5.send_keys("selenium下载测试文件夹")
elem6 = driver.find_element_by_css_selector(".sure")
elem6.click()
time.sleep(2)

#勾选文件夹
elem10 = driver.find_element_by_xpath("//a[@class='display-name' and @title='selenium下载测试文件夹']/../../../..").find_element_by_class_name("item-checkbox") #勾选文件
elem10.click()
time.sleep(1)
elem11 = driver.find_element_by_class_name("fileMore")                                       #点击更多
ActionChains(driver).move_to_element(elem11).perform()
time.sleep(1)
elem12 = driver.find_element_by_class_name("download")                                       #点击下载
elem12.click()